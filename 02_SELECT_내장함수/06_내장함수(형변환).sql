...
FROM DUAL;
SELECT TO_CHAR(1230.5555, 'L999,999.99'), TO_CHAR(1230.5555, 'L000,000.00') 
FROM DUAL;
SELECT TO_CHAR(1230.5544, 'L999,999.99'), TO_CHAR(1230.5544, 'L000,000.00') 
FROM DUAL;
----------------------------
...
SELECT TO_DATE('2021-04-16', 'YYYY-MM-DD') + 1 FROM DUAL; --2021/04/17
